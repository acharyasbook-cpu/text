...
<footer class="border-t border-[#E3E6F0] bg-white mt-12">
  <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center text-sm text-slate-600">
    <p class="font-telugu font-semibold text-slate-900"><?= e($header['site_name_te'] ?? 'ఆచార్యస్ బుక్') ?></p>
    <p class="mt-1 classical-brand-domain text-sm">&copy; <?= date('Y') ?> <?= e($header['site_tagline_te'] ?? 'acharyasbook.com') ?> · All rights reserved.</p>
  </div>
</footer>
